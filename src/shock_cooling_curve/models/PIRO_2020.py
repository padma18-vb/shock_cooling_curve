...
class PIRO_2020(Supernova):
    ...
    def luminosity(self, t, Re, Me, ve):
        ...
        set = ction are assumed from Chevalier & Soker (1989) [https://ui.adsabs.harvard.edu/abs/1989ApJ...341..867C/abstract]'''
        ...
        L_cgs[t_smaller_td] = np.array(prefactor * (self._td(Me_cgs, vt_cgs) / t_cgs) ** (4 / (self.n - 2)))[t_smaller_td]
